  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        <!-- Fill form to post a comment  -->
            ...
            <form action="{{route('comment_post')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="flex h-12">
                ...
                @foreach($comments as $comment)
                    ...
                    <div class="flex bg-slate-50 p-6 rounded-lg">
                            <img class="w-10 h-10 sm:w-12 sm:h-12 object-cover rounded-full" src="" alt="image de profil de {{$comment->user->name}}">
